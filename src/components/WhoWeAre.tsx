  ...
  return (
    <section className="bg-white font-jersey p-6 pt-12 mb-11 justify-center min-h-screen w-full">
      <div className="flex-col">
        <h2 className="text-6xl sm:text-8xl mt-8 sm:pt-20 md:pt-14 pb-2 text-center text-primary">
          What Is CareTech?
        </h2>
        <div className="flex justify-between  flex-col lg:px-4 lg:flex-row md:pt-16">
          <p className="font-normal lg:text-xl px-4 pr-0 lg:pr-10 md:text-md sm:[font-size:20px] sm:mb-10 sm:mt-8 text-[#294B7B] flex-1 w-full">
            We are an <b>ICS-affiliated organization</b> that aims to bring
            groundbreaking healthcare inventions to life to increase{" "}
            <b>early-disease detection</b>. Join one of our committees to get{" "}
            <b>hands-on experience</b> working on projects and{" "}
            <b>building healthcare tech innovations</b>. Gain valuable skills
            about AI in the health and technology field and{" "}
          ...
          <img
            className="mt-6 lg:mt-0 px-4 w-full lg:max-w-lg h-auto object-contain rounded-lg"
